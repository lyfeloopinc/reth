...
/// from database storage and from the blockchain tree (pending state etc.).
///
/// It is a simple wrapper type that holds an instance of the database and the blockchain tree, and
/// implements most provider or provider factory traits.
#[derive(Debug)]
...
mod tests {
    ...
    fn provider_with_chain_spec_and_random_blocks(
        ...
        BlockchainProviderFactory<MockNodeTypesWithDB>,
        Vec<SealedBlock>,
        Vec<SealedBlock>,
        Vec<Vec<Receipt>>,
    )> {
